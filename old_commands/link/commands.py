...
from utility.emojis import get_guild_icon
...
class Linking(LinkButtonExtended, commands.Cog):
    ...
    async def link(
        ...
        linked_embeds = [
            disnake.Embed(
                title='Link Complete',
                description=f'[{player.name}]({player.share_link}) linked to {user.mention}',
    ...
    @commands.slash_command(
        name='buttons',
        description='Create a message that has buttons for easy eval/link/refresh actions.',
    )
    async def buttons(
        self,
        ctx: disnake.ApplicationCommandInteraction,
        ...
        if embed is not None:
            ...
            default_embeds = {
                'Link Button': disnake.Embed(
                    ...
                    description='To link your account, press the link button below to get started.',
                    color=embed_color,
                ),
                'Refresh Button': disnake.Embed(
                    title=f'**Welcome to {ctx.guild.name}!**',
                    description='To refresh your roles, press the refresh button below.',
                    color=embed_color,
                ),
                'To-Do Button': disnake.Embed(
                    description='To view your account to-do list click the button below!\n'
                    '> Clan Games\n'
                    '> War Hits\n'
                    '> Raid Hits\n'
                    '> Inactivity\n'
                ...
                'Roster Button': disnake.Embed(
                    description='To view all the rosters you are on & the what group (Main, Benched, etc) '
                    '& clans your accounts are in, press the button below.',
                    color=embed_color,
                ),
                'other': disnake.Embed(
                    description='Use the buttons below to view info about your accounts.',
                    color=embed_color,
                ),
        ...
        if not on_welcome_channel:
            ...
            await ctx.edit_original_message(
                content=f'This is what your message will look like & it will post in {on_welcome_channel.mention}',
                embeds=embeds,
                components=[buttons],
            )
