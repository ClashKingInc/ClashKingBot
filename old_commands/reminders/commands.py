...
class ReminderCommands(commands.Cog, name='Reminders'):
    ...
    async def setup_reminders(
        ...
        await ctx.edit_original_message(content='Setup Complete!', components=[])
    ...
    async def personal_reminders(
        ...
        account: coc.Player = commands.Param(autocomplete=autocomplete.user_accounts, converter=convert.player),
    ):
