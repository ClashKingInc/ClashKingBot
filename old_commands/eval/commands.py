...
from .utils import family_role_add, family_role_remove, logic
...
class eval(commands.Cog, name='Refresh'):
    ...
    async def refresh(
        ...
        embeds = await logic(
            ...
            test=test,
            role_treatment=([role_treatment] if role_treatment != 'Both' else ['Add', 'Remove']),
        )
    ...
    async def category_role(
        ...
        results = await self.bot.clan_db.find_one({'$and': [{'category': category}, {'server': ctx.guild.id}]})
    ...
    async def role_list(self, ctx: disnake.ApplicationCommandInteraction):
        ...
        if list_ths == '':
            list_ths = 'None Set'
        embed.add_field(name='**Townhall Roles**', value=list_ths)
        ...
        if list_ths == '':
            list_ths = 'None Set'
        embed.add_field(name='**Builderhall Roles**', value=list_ths)
        ...
        if list == '':
            list = 'None Set'
        embed.add_field(name='**League & Trophy Roles**', value=list)
        ...
        if list == '':
            list = 'None Set'
        embed.add_field(name='**Builder League Roles**', value=list)
        ...
        if list == '':
            list = 'None Set'
        embed.add_field(name='**Status Roles**', value=list)
        ...
        if list == '':
            list = 'None Set'
        embed.add_field(name='**Achievement Roles**', value=list)
    ...
    async def role_remove(
        ...
        removed_text = ''
        if townhall:
            results = await self.bot.townhallroles.find_one({'$and': [{'th': f'{townhall}'}, {'server': ctx.guild.id}]})
            if results is None:
