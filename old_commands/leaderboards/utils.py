...
async def hv_player_leaderboard(
    ...
    for chunk in text_chunks:
        embed = disnake.Embed(
            title=f'{location_emoji} {country_name} Top 200 Players',
            description=chunk,
            color=embed_color,
        )
        embeds.append(embed)
...
async def hv_clan_leaderboard(
    ...
    for chunk in text_chunks:
        embed = disnake.Embed(
            title=f'{location_emoji} {country_name} Top 200 HV Clans',
            description=chunk,
            color=embed_color,
        )
        embeds.append(embed)
...
async def clan_capital_leaderboard(
    ...
    for chunk in text_chunks:
        embed = disnake.Embed(
            title=f'{location_emoji} {country_name} Top 200 Capital Clans',
            description=chunk,
            color=embed_color,
        )
        embeds.append(embed)
...
async def bb_player_leaderboard(
    ...
    for chunk in text_chunks:
        embed = disnake.Embed(
            title=f'{location_emoji} {country_name} Top 200 BB Players',
            description=chunk,
            color=embed_color,
        )
        embeds.append(embed)
...
async def bb_clan_leaderboard(
    ...
    for chunk in text_chunks:
        embed = disnake.Embed(
            title=f'{location_emoji} {country_name} Top 200 BB Clans',
            description=chunk,
            color=embed_color,
        )
        embeds.append(embed)
