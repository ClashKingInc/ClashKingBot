...
async def main(PLAYER_CLIENTS):
    ...
    while True:
        try:
            ...
            async def send_ws(ws: WebSocket, json):
                ws.state
                error = False
                try:
...
if __name__ == '__main__':
    ...
    config = Config(app=app, loop="asyncio", host= "85.10.200.219", port=65001, ws_ping_interval=3600, ws_ping_timeout=3600, timeout_keep_alive=0, timeout_notify=3600, ws="websockets")
