    ...
    while True:
        try:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                await session.close()
            async with websockets.connect(f"ws://{WEBSOCKET_IP}/players?token={token}", ping_timeout=None, ping_interval=None, open_timeout=None, max_queue=50000) as websocket:
