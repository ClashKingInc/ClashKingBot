...
class War(commands.Cog):
    ...
    async def war_search(self, ctx: disnake.ApplicationCommandInteraction,
        ...
        select = disnake.ui.Select(
            options=[  # the options in your dropdown
                disnake.SelectOption(label="War Overview", emoji=self.bot.emoji.hashmark.partial_emoji, value="war"),
                disnake.SelectOption(label="Clan Roster", emoji=self.bot.emoji.troop.partial_emoji, value="croster"),
                disnake.SelectOption(label="Opponent Roster", emoji=self.bot.emoji.troop.partial_emoji, value="oroster"),
                disnake.SelectOption(label="Attacks", emoji=self.bot.emoji.wood_swords.partial_emoji, value="attacks"),
                disnake.SelectOption(label="Defenses", emoji=self.bot.emoji.shield.partial_emoji, value="defenses"),
                disnake.SelectOption(label="Opponent Defenses", emoji=self.bot.emoji.clan_castle.partial_emoji, value="odefenses"),
                disnake.SelectOption(label="Opponent Clan Overview", emoji=self.bot.emoji.magnify_glass.partial_emoji, value="opp_over")
            ],
    ...
    async def war_plan(self, ctx: disnake.ApplicationCommandInteraction,
