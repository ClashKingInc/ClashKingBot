...
class Bans(commands.Cog, name='Bans'):
    ...
    @commands.slash_command(
        name='ban',
        description=Loc(key='ban-description'),
    ...
    @ban.sub_command(
        name='add',
        description=Loc(key='add-description'),
        extras={'docs': 'https://docs.clashking.xyz/clans-management/bans'},
    )
    ...
    async def ban_add(
        ...
        reason: str = commands.Param(
            name=Loc(key='reason-option'),
            description=Loc(key='reason-description'),
            default=None,
        ),
        dm_player: str = commands.Param(
            name=Loc(key='dm-player-option'),
            description=Loc(key='dm-player-description'),
            default=None,
        ),
    ):
    ...
    @ban.sub_command(
        name='remove',
        description=Loc(key='remove-description'),
        extras={'docs': 'https://docs.clashking.xyz/clans-management/bans'},
    )
    @commands.check_any(commands.has_permissions(manage_guild=True), check_commands())
    ...
    @ban.sub_command(
        name='list',
        description=Loc(key='list-description'),
        extras={'docs': 'https://docs.clashking.xyz/clans-management/bans'},
    )
    @commands.check_any(commands.has_permissions(manage_guild=True), check_commands())
    async def ban_list(
        ...
        bans = await self.bot.ck_client.get_ban_list(server_id=ctx.guild_id)
        if not bans:
