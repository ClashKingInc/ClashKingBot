...
def war_buttons(bot: CustomClient, new_war: coc.ClanWar):
    ...
    button = [disnake.ui.ActionRow(
        disnake.ui.Button(label="", emoji=bot.emoji.refresh.partial_emoji,
                          style=disnake.ButtonStyle.grey,
                          custom_id=f"warpanelrefresh_{new_war.clan.tag}_{war_unique_id}"),
        disnake.ui.Button(label="", emoji=bot.emoji.sword_clash.partial_emoji,
                          style=disnake.ButtonStyle.grey,
                          custom_id=f"listwarattacks_{new_war.clan.tag}_{war_unique_id}"),
        disnake.ui.Button(label="", emoji=bot.emoji.shield.partial_emoji,
                          style=disnake.ButtonStyle.grey,
