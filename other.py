...
class misc(commands.Cog, name="Other"):
    ...
    async def summary(self, ctx: disnake.ApplicationCommandInteraction, num_messages: int = 100):
        ...
        magicbot = ChatBot(f"You are a chatbot that helps summarize conversations in a discord channel. Summarize primarily using bullet points. Be concise, but tell the whole story.")
