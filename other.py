...
class misc(commands.Cog, name="Other"):
    ...
    async def summary(self, ctx: disnake.ApplicationCommandInteraction, num_messages: int = 100):
        ...
        magicbot = ChatBot(f"You are a chatbot that helps summarize conversations in a discord channel. Summarize highlights & topics of the conversation into bulletpoints (up to 25 of them).")
