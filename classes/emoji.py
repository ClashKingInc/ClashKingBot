import disnake
from assets.emojiDictionary import emoji_class_dict
...
class Emojis():
    def __init__(self):
        self.discord = EmojiType(emoji_class_dict.get("discord"))
        self.clan_castle = EmojiType(emoji_class_dict.get("clan_castle"))
        self.shield = EmojiType(emoji_class_dict.get("shield"))
        self.trophy = EmojiType(emoji_class_dict.get("trophy"))
        self.capital_gold = EmojiType(emoji_class_dict.get("capital_gold"))
        self.legends_shield = EmojiType(emoji_class_dict.get("legends_shield"))
        self.sword = EmojiType(emoji_class_dict.get("sword"))
        self.previous_days = EmojiType(emoji_class_dict.get("previous_days"))
        self.legends_overview = EmojiType(emoji_class_dict.get("legends_overview"))
        self.graph_and_stats = EmojiType(emoji_class_dict.get("graph_and_stats"))
        self.history = EmojiType(emoji_class_dict.get("history"))
        self.quick_check = EmojiType(emoji_class_dict.get("quick_check"))
        self.gear = EmojiType(emoji_class_dict.get("gear"))
        self.pin = EmojiType(emoji_class_dict.get("pin"))
        self.back = EmojiType(emoji_class_dict.get("back"))
        self.forward = EmojiType(emoji_class_dict.get("forward"))
        self.print = EmojiType(emoji_class_dict.get("print"))
        self.refresh = EmojiType(emoji_class_dict.get("refresh"))
        self.trashcan = EmojiType(emoji_class_dict.get("trashcan"))
        self.alphabet = EmojiType(emoji_class_dict.get("alphabet"))
        self.start = EmojiType(emoji_class_dict.get("start"))
        self.blue_shield = EmojiType(emoji_class_dict.get("blue_shield"))
        self.blue_sword = EmojiType(emoji_class_dict.get("blue_sword"))
        self.blue_trophy = EmojiType(emoji_class_dict.get("blue_trophy"))
        self.grey_circle = EmojiType(emoji_class_dict.get("grey_circle"))
        self.earth = EmojiType(emoji_class_dict.get("earth"))
        self.sword_clash = EmojiType(emoji_class_dict.get("sword_clash"))
        self.war_star = EmojiType(emoji_class_dict.get("war_star"))
        self.blank = EmojiType(emoji_class_dict.get("blank"))
        self.clock = EmojiType(emoji_class_dict.get("clock"))
        self.troop = EmojiType(emoji_class_dict.get("troop"))
        self.reddit_icon = EmojiType(emoji_class_dict.get("reddit_icon"))
        self.xp = EmojiType(emoji_class_dict.get("xp"))
        self.deny_mark = EmojiType(emoji_class_dict.get("deny_mark"))
        self.raid_medal = EmojiType(emoji_class_dict.get("raid_medal"))
        self.clan_games = EmojiType(emoji_class_dict.get("clan_games"))
        self.time = EmojiType(emoji_class_dict.get("time"))
        self.no_star = EmojiType(emoji_class_dict.get("no_star"))
        self.yes = EmojiType(emoji_class_dict.get("yes"))
        self.no = EmojiType(emoji_class_dict.get("no"))
        self.gear = EmojiType(emoji_class_dict.get("gear"))
        self.ratio = EmojiType(emoji_class_dict.get("ratio"))
        self.switch = EmojiType(emoji_class_dict.get("switch"))
        self.menu = EmojiType(emoji_class_dict.get("menu"))
        self.elixir = EmojiType(emoji_class_dict.get("elixir"))
        self.dark_elixir = EmojiType(emoji_class_dict.get("dark_elixir"))
        self.gold = EmojiType(emoji_class_dict.get("gold"))
        self.brown_shield = EmojiType(emoji_class_dict.get("brown_shield"))
        self.thick_sword = EmojiType(emoji_class_dict.get("thick_sword"))
        self.hitrate = EmojiType(emoji_class_dict.get("hitrate"))
        self.avg_stars = EmojiType(emoji_class_dict.get("avg_stars"))
        self.war_stars = EmojiType(emoji_class_dict.get("war_stars"))
        self.versus_trophy = EmojiType(emoji_class_dict.get("versus_trophy"))
        self.up_green_arrow = EmojiType(emoji_class_dict.get("up_green_arrow"))
        self.down_red_arrow = EmojiType(emoji_class_dict.get("down_red_arrow"))
        self.capital_trophy = EmojiType(emoji_class_dict.get("capital_trophy"))
        self.cwl_medal = EmojiType(emoji_class_dict.get("cwl_medal"))
        self.person = EmojiType(emoji_class_dict.get("person"))
        self.excel = EmojiType(emoji_class_dict.get("excel"))
        self.magnify_glass = EmojiType(emoji_class_dict.get("magnify_glass"))
        self.right_green_arrow = EmojiType(emoji_class_dict.get("right_green_arrow"))
        self.calendar = EmojiType(emoji_class_dict.get("calendar"))
        self.red_status = EmojiType(emoji_class_dict.get("red_status"))
        self.green_status = EmojiType(emoji_class_dict.get("green_status"))
        self.toggle_on = EmojiType(emoji_class_dict.get("toggle_on"))
        self.toggle_off = EmojiType(emoji_class_dict.get("toggle_off"))
        self.unranked = EmojiType(emoji_class_dict.get("unranked"))
        self.hashmark = EmojiType(emoji_class_dict.get("hashmark"))
        self.red_tick = EmojiType(emoji_class_dict.get("red_tick"))
        self.green_tick = EmojiType(emoji_class_dict.get("green_tick"))
        self.opt_in = EmojiType(emoji_class_dict.get("opt_in"))
        self.opt_out = EmojiType(emoji_class_dict.get("opt_out"))
        self.globe = EmojiType(emoji_class_dict.get("globe"))
        self.wood_swords = EmojiType(emoji_class_dict.get("wood_swords"))
        self.red_pin = EmojiType(emoji_class_dict.get("red_pin"))
        self.wbb_red = EmojiType(emoji_class_dict.get("wbb_red"))
        self.spells = EmojiType(emoji_class_dict.get("spells"))
        self.heart = EmojiType(emoji_class_dict.get("heart"))
        self.pet_paw = EmojiType(emoji_class_dict.get("pet_paw"))
